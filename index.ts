...
(async () => {
  ...
  try {
    ...
    let newApiFileContent = apiFileContent.replace(
      /delete localVarUrlObj.search;/g,
      "localVarUrlObj.search = null;"
    );

    newApiFileContent = newApiFileContent.replace(
    ...
    await FileSystem.unlinkAsync(
      resolve(tmpOutputPath, ".openapi-generator", "VERSION")
    );
